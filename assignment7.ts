...
// 18. Write a ts program to find highest frequency character in a string.
        var str1, visited;
        var count, flag = 0;
         var i, j = 0, k = 0, l, max, index;
  str1="Welcome to Sanfoundry's C Programming Class"
    l = str1.length;
    console.log(l)
//     for (i = 0; i < l; i++)
//     {
...
//         }
//     }
    console.log("Max repeated character in the string = ", visited[index]);
    console.log("It occurs times", count[index]);
